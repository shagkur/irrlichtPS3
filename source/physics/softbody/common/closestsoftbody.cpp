...
#define SFTCONTACTFUNC(funcName) \
s32 funcName(\
				ContactPoint *cp,\
				const Sphere& sphereA, const Transform3& primTransformA,\
				const CollPrim& primB, const Transform3& primTransformB, const Transform3& relTransformB, s32 primIndexB,\
				f32 objsInContactDist);

typedef s32 (*SftContacts)(ContactPoint *cp, const Sphere& sphereA, const Transform3& primTransformA, const CollPrim& primB, const Transform3& primTransformB, const Transform3& relTransformB, s32 primIndexB, f32 objsInContactDist);

SFTCONTACTFUNC(sftContactsSphere		)
SFTCONTACTFUNC(sftContactsBox			)
SFTCONTACTFUNC(sftContactsCapsule		)
SFTCONTACTFUNC(sftContactsHeightField	)
SFTCONTACTFUNC(sftContactsConvex		)
SFTCONTACTFUNC(sftContactsLargeMesh		)
SFTCONTACTFUNC(sftContactsDummy			)

SftContacts funcTbl_sftContacts[PRIM_COUNT] =
	{sftContactsSphere,sftContactsBox,sftContactsCapsule,sftContactsHeightField,sftContactsConvex,sftContactsDummy,sftContactsLargeMesh};
...
s32 sftContactsDummy(ContactPoint *cp, const Sphere& sphereA, const Transform3& primTransformA, const CollPrim& primB, const Transform3& primTransformB, const Transform3& relTransformB, s32 primIndexB, f32 objsInContactDist)
{
	(void) cp;
	(void) sphereA;
	(void) primTransformA;
...
s32 sftContactsBox(ContactPoint *cp, const Sphere& sphereA, const Transform3& primTransformA, const CollPrim& primB, const Transform3& primTransformB, const Transform3& relTransformB, s32 primIndexB, f32 objsInContactDist)
{
	Vector3 testNormal;
...
s32 sftContactsCapsule(ContactPoint *cp, const Sphere& sphereA, const Transform3& primTransformA, const CollPrim& primB, const Transform3& primTransformB, const Transform3& relTransformB, s32 primIndexB, f32 objsInContactDist)
{
	Vector3 testNormal;
	SpherePoint spherePointA;
...
s32 sftContactsSphere(ContactPoint *cp, const Sphere& sphereA, const Transform3& primTransformA, const CollPrim& primB, const Transform3& primTransformB, const Transform3& relTransformB, s32 primIndexB, f32 objsInContactDist)
{
...
s32 sftContactsConvex(ContactPoint *cp, const Sphere& sphereA, const Transform3& primTransformA, const CollPrim& primB, const Transform3& primTransformB, const Transform3& relTransformB, s32 primIndexB, f32 objsInContactDist)
{
	Vector3 testNormal;
...
int sftContactsHeightField(ContactPoint *cp, const Sphere& sphereA, const Transform3& primTransformA, const CollPrim& primB, const Transform3& primTransformB, const Transform3& relTransformB, s32 primIndexB, f32 objsInContactDist)
{
	(void) primTransformB;
	(void) objsInContactDist;
...
s32 sftContactsLargeMesh(ContactPoint *cp, const Sphere& sphereA, const Transform3& primTransformA, const CollPrim& primB, const Transform3& primTransformB, const Transform3& relTransformB, s32 primIndexB, f32 objsInContactDist)
{
	s32 numContacts = 0;
...
// Particle x Particle
bool closestContactPcl(SoftContactPair& contactPair, const Vector3& posA, f32 radA, const Vector3& posB, f32 radB, f32 objsInContactDist)
{
	Vector3 testNormal(0.0f);
	SpherePoint spherePointA;
	SpherePoint spherePointB;
...
bool closestContactRig(SoftContactPair& contactPair, const Vector3& posA, f32 radA, const CollObject& objB, const Transform3& transformB, f32 objsInContactDist)
{
	...
	for(s32 j=0;j < objB.getNumPrims();j++, ++itrPrim) {
		...
		s32 newContacts = funcTbl_sftContacts[primB.getType()](cp, sphereA, primTransformA, primB, primTransformB, relTransformB, j, objsInContactDist);
